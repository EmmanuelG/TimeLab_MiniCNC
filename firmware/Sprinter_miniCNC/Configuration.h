...
#define _AXIS_STEP_PER_UNIT {2560, 2560, 2560,700}
...
#define _ACCELERATION 10         // Axis Normal acceleration mm/s^2
#define _RETRACT_ACCELERATION 500 // Extruder Normal acceleration mm/s^2
#define _MAX_XY_JERK 0.4
#define _MAX_Z_JERK 0.4
#define _MAX_E_JERK 5.0    // (mm/sec)
//#define _MAX_START_SPEED_UNITS_PER_SECOND {25.0,25.0,0.2,10.0}
#define _MAX_ACCELERATION_UNITS_PER_SQ_SECOND {50,50,50,50}    // X, Y, Z and E max acceleration in mm/s^2 for printing moves or retracts
